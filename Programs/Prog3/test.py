...
d = alsaaudio.PCM(alsaaudio.PCM_PLAYBACK, device='default')

d.setchannels(1)
d.setrate(sample_rate)
d.setformat(alsaaudio.PCM_FORMAT_S16_LE) # 16 bit little endian frames
d.setperiodsize(period_size)
